...
Lives in the infrastructure layer because ORM models for Program/Scope/
ScopeChange are SHARED across bounded contexts (program_ranking,
scope_management, ...). Domain code imports VOs/Aggregates only — the ORM
mapping stays here.
"""
