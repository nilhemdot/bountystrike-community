...
port 5100 if not running, executes the 20-target corpus through
...
Usage::
    ...
    python ../../scripts/run_ssrf_imds_field_validation.py
"""
...
FIXTURE = ORACLE_DIR / "tests" / "fixtures" / "ssrf_imds_targets.json"
LAB_APP = ORACLE_DIR / "tests" / "fixtures" / "ssrf_imds_lab" / "app.py"
REPORT = ORACLE_DIR / "tests" / "reports" / "phase2_ssrf_imds_tpr_fpr.json"
LAB_HOST = "127.0.0.1"
LAB_PORT = 5100
...
def main() -> int:
    ...
    try:
        ...
        print(
            f"Phase 2 SSRF→IMDS field validation: "
