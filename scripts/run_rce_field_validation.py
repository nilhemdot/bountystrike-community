...
not running, executes the 20-target corpus through ``FieldValidationRunner``,
...
Usage::
    ...
    python ../../scripts/run_rce_field_validation.py
"""
...
FIXTURE = ORACLE_DIR / "tests" / "fixtures" / "rce_targets.json"
LAB_APP = ORACLE_DIR / "tests" / "fixtures" / "rce_lab" / "app.py"
REPORT = ORACLE_DIR / "tests" / "reports" / "phase2_rce_tpr_fpr.json"
LAB_HOST = "127.0.0.1"
LAB_PORT = 5093
...
def main() -> int:
    ...
    try:
        ...
        print(
            f"Phase 2 RCE field validation: "
